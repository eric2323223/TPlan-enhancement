 ...
 * @product.signature
 */
public class HigherVersionInstalledException extends Exception {
    private PluginInfo pluginInfo;
    private PluginInfo installedPluginInfo;
    private static final String msg = ApplicationSupport.getResourceBundle().getString("com.tplan.robot.plugin.higherVersionInstalledEx");
     ...
     */
    public HigherVersionInstalledException(PluginInfo pluginInfo, PluginInfo installedPluginInfo) {
