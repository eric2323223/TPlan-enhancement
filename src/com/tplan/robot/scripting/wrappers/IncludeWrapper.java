...
/**
 * Wrapper implementing functionality of the {@doc.cmd Include} command.
 * @product.signature
 */
public class IncludeWrapper extends GenericWrapper {

    private Element parentElement;

    public IncludeWrapper(StyledDocument document, int selectionStart, int selectionEnd, boolean selectionMode) {
