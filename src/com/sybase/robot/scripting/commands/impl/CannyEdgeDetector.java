...
public class CannyEdgeDetector {
	...
	public BufferedImage getEdgesImage() {
		return edgesImage;
//		return edgesImage.getSubimage(8, 8, edgesImage.getWidth()-16, edgesImage.getHeight()-16);
	}
	...
	public Image process(Image image) {
		sourceImage = ImageUtil.imageToBufferedImage(image);
		width = sourceImage.getWidth();
		height = sourceImage.getHeight();
		picsize = width * height;
		initArrays();
	...
	public void writeEdgeImageToFile(File file){
		java.awt.image.BufferedImage edges = getEdgesImage();
		try {
			javax.imageio.ImageIO.write(edges, "PNG", file);
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
